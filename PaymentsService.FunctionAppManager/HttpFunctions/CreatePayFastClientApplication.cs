...
public class CreatePayFastClientApplication
{
    ...
    private readonly IFunctionsHostManager _functionsHostManager;

    public CreatePayFastClientApplication(
        IServiceBusManager serviceBusManager,
        IFunctionsHostManager functionsHostManager)
    {
        _serviceBusManager = serviceBusManager;
        _functionsHostManager = functionsHostManager;
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        var keyName = $"client-app-autogenerated-{applicationId}";
        var createFunctionsHostKeyResult = await _functionsHostManager.CreateHostSecretKeyIfNotExists(
            keyName,
            cancellationToken);
        responseObjects.Add(new KeyValuePair<string, object>(
            createFunctionsHostKeyResult.IsNew ? "Function key created" : "Function key already existed",
            createFunctionsHostKeyResult));
