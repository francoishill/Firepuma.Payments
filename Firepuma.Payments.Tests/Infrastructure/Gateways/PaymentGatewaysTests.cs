...
namespace Firepuma.Payments.Tests.Infrastructure.Gateways;
...
public class PaymentGatewaysTests
{
    ...
    {
        //TODO: enable once we have a second payment gateway
    ...
    private static IEnumerable<IPaymentGateway> PaymentGatewayInstances =>
        AppDomain.CurrentDomain.GetAssemblies()
            ...
            .Concat(new[]
            {
                // just pin a few types to ensure their project/assembly is included
